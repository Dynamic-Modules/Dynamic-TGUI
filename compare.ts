...
const paths = getDynamicTguiPaths();
const moduleRoot = paths.moduleRoot;
const repoRoot = paths.hostRoot;
const tguiRoot = paths.tguiRoot;
...
const definitions = loadModularTguiDefinitions(moduleRoot, {
	manifestFiles: loadDynamicModuleTguiFiles(paths),
	overrides,
	patches,
	scanRoots,
});
